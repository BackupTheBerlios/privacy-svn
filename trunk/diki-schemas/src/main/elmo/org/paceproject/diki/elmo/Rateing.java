 ...
 *
 */
@rdf("http://rdf.pace-project.org/diki#Rateing")
public interface Rateing {

	@rdf("http://rdf.pace-project.org/diki#rateing")
	public double getRateing();
	public void setRateing(double rating);

	@rdf("http://rdf.pace-project.org/diki#ratedItem")
	public Object getRatedItem();
	public void setRatedItem(Object ratedItem);
}
