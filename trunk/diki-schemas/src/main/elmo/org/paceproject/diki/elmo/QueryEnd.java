 ...
 *
 * When this packet is recieved, the Query is finished and no further results are available.
 */
@rdf("http://rdf.pace-project.org/diki#QueryEnd")
@disjointWith({Query.class})
public interface QueryEnd extends QueryAnswer{
