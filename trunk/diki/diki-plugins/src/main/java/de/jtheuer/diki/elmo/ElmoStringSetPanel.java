 ...
 *
 */
public class ElmoStringSetPanel extends ElmoObjectPanel<String> {
	/* automatically generated Logger */@SuppressWarnings("unused")
	private static final Logger LOGGER = Logger.getLogger(ElmoStringSetPanel.class.getName());

	private String content;
	private JTextField textField;

	public ElmoStringSetPanel(String label,Set<String> string) {
		super(label,string,null);
		content = firstOrNull(string);
	}
